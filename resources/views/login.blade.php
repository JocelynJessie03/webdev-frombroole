...
<div class="login-card z-10">
    ...
    <div class="login-left">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <img src="{{ asset('images/oreo_broole.png') }}"       class="absolute opacity-40 blur-[1px] w-[96px] top-[15%] left-[10%] floating" >
            <img src="{{ asset('images/strawberry_broole.png') }}" class="absolute opacity-40 blur-[1px] w-[80px] top-[10%] left-[85%] floating" style="animation-delay:1s">
            <img src="{{ asset('images/matcha_broole.png') }}"     class="absolute opacity-40 blur-[1px] w-[90px] top-[80%] left-[75%] floating" style="animation-delay:2s">
            <img src="{{ asset('images/toa.png') }}"               class="absolute opacity-40 blur-[1px] w-[50px] top-[75%] left-[20%] floating" style="animation-delay:1.5s">
            <img src="{{ asset('images/choco_broole.png') }}"      class="absolute opacity-40 blur-[1px] w-[70px] top-[60%] left-[5%]  floating" style="animation-delay:0.5s">
            <img src="{{ asset('images/letter.png') }}"            class="absolute opacity-40 blur-[1px] w-[80px] top-[50%] left-[90%] floating" style="animation-delay:3s">
            <img src="{{ asset('images/bow.png') }}"               class="absolute opacity-40 blur-[1px] w-[70px] top-[40%] left-[5%]  floating" style="animation-delay:2.5s">
        </div>
        ...
        <div class="relative z-10 text-center">
            <div class="logo-circle w-40 h-40 bg-white rounded-full flex items-center justify-center mx-auto mb-10 shadow-2xl ring-[12px] ring-white/10">
                <img src="{{ asset('home_assets/logo.png') }}" class="w-full h-full object-contain p-3">
            </div>
        ...
        <div class="login-branding absolute bottom-6 left-10 flex items-center gap-3">
            <div class="w-8 h-8 bg-white/20 rounded flex items-center justify-center p-1.5 backdrop-blur-sm">
                <img src="{{ asset('images/spork.png') }}" class="w-full h-full object-contain brightness-0 invert">
            </div>
...
<div id="errorModal" class="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
    <div class="bg-white w-[90%] max-w-md rounded-[2rem] p-8 shadow-2xl text-center">
        ...
        <p class="text-gray-500 font-medium mb-6 leading-relaxed">{{ $errors->first() }}</p>
