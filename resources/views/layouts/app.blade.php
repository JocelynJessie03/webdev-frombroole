            ...
            <div class="flex h-20 items-center justify-between px-4 lg:px-6">
                ...
                <nav class="hidden flex-1 items-center justify-center gap-1 lg:flex">
                    ...
                    <a
                        ...
                        {{ Route::is('customer.home') ? 'text-[#8C1717] is-active' : 'text-[#7A6E68] hover:text-[#8C1717]' }}"
                    >
                        Home
                    ...
                    <a
                        ...
                        class="group relative rounded-md px-4 py-2 font-['Montserrat'] text-[10px] font-semibold uppercase tracking-[0.25em] transition-colors
                        {{ Route::is('customer.shop') ? 'text-[#8C1717] is-active' : 'text-[#7A6E68] hover:text-[#8C1717]' }}"
                    >
                        Shop
                        <span class="nav-link-underline"></span>
                    </a>
                    ...
                    <a
                        ...
                        {{ Route::is('customer.history') ? 'text-[#8C1717] is-active' : 'text-[#7A6E68] hover:text-[#8C1717]' }}"
                    >
                        Transaction History
                        <span class="nav-link-underline"></span>
                    </a>
                    ...
                    <a
                       href="{{ route('customer.contact') }}"
                        class="group relative rounded-md px-4 py-2 font-['Montserrat'] text-[10px] font-semibold uppercase tracking-[0.25em] transition-colors
                        {{ Route::is('customer.contact') ? 'text-[#8C1717] is-active' : 'text-[#7A6E68] hover:text-[#8C1717]' }}"
                    >
                        Contact
                        <span class="nav-link-underline"></span>
                    </a>
                    ...
                    <a
                        ...
                        class="group relative rounded-md px-4 py-2 font-['Montserrat'] text-[10px] font-semibold uppercase tracking-[0.25em] transition-colors
                        {{ Route::is('customer.about') ? 'text-[#8C1717] is-active' : 'text-[#7A6E68] hover:text-[#8C1717]' }}"
                    >
                        About
                        <span class="nav-link-underline"></span>
                    </a>
                ...
                <div class="flex flex-shrink-0 items-center gap-2.5">
                    ...
                    <a href="/cart" id="nav-cart-btn" aria-label="View cart">
                        ...
                        {{-- Live badge — hidden until items added --}}
            ...
            >
                ...
                >
                    ...
                    <div class="flex flex-col p-6 gap-5">
                        ...
                        <a href="{{ route('customer.tasks.index') }}" class="font-semibold text-[#7A6E68] requires-auth">
                            Coupons
                        </a>

                        <a href="{{ route('customer.history') }}" class="font-semibold text-[#7A6E68] requires-auth">
                            Transaction History
                        </a>
...
{{-- Init nav cart badge from localStorage on every page --}}
<script>
(function () {
