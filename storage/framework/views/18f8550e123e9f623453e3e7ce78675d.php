...
<body class="min-h-screen bg-[#f7f2f1] flex items-center justify-center p-0 md:p-8 overflow-x-hidden">

<div class="register-card w-full max-w-6xl bg-white rounded-[2.5rem] shadow-[0_40px_80px_-20px_rgba(107,13,13,0.15)] overflow-hidden flex flex-col md:flex-row min-h-[700px] md:h-[750px]">

 <!-- LEFT SIDE -->
    <div class="register-left w-full md:w-[45%] bg-[#7a0d0d] relative overflow-hidden flex flex-col items-center justify-center p-12 text-white">
        ...
        <!-- Bottom Branding -->
        <div class="register-branding absolute bottom-6 left-10 flex items-center gap-3">
    ...
    <!-- RIGHT SIDE -->
    <div class="register-right w-full md:flex-1 bg-[#fffdfd] p-5 md:p-8 flex flex-col justify-center">
...
<?php endif; ?>
</html><?php /**PATH D:\Herd\webdev-frombroole\resources\views/register.blade.php ENDPATH**/ ?>