                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-5">
                    ...
                    <div class="border rounded-2xl p-4 flex items-center justify-between bg-gray-50/50 hover:bg-white transition ingredient-card">
                        ...
                        <div class="flex items-center gap-3">
                            <input 
                                type="checkbox" 
                                id="ing-<?php echo e($ingredient->id); ?>"
                                class="w-5 h-5 rounded text-[#7b0000] focus:ring-[#7b0000] border-gray-300 ingredient-checkbox"
                                onchange="toggleQuantityInput(this, 'input-ing-<?php echo e($ingredient->id); ?>')"
                            >
                            <label for="ing-<?php echo e($ingredient->id); ?>" class="font-bold text-gray-700 select-none cursor-pointer">
                                <?php echo e($ingredient->name); ?>

                                <span class="block text-xs font-normal text-gray-400">Unit: <?php echo e($ingredient->unit); ?></span>
                            </label>
                        </div>
                        ...
                        <div class="w-28">
                            <input 
                                type="number" 
                                id="input-ing-<?php echo e($ingredient->id); ?>"
...
<?php echo $__env->make('partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Herd\webdev-frombroole\resources\views/product/create.blade.php ENDPATH**/ ?>