        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-gray-50 transition">
                    <td class="px-6 py-5 font-bold"><?php echo e($admin->name); ?></td>
                    <td class="px-6 py-5 text-gray-600"><?php echo e($admin->username); ?></td>
                    <td class="px-6 py-5 text-gray-600"><?php echo e($admin->email); ?></td>
                    <td class="px-6 py-5">
                        <span class="px-3 py-1 text-xs font-bold uppercase rounded-full <?php echo e($admin->role === 'super_admin' ? 'bg-[#fff2c9] text-yellow-700' : 'bg-gray-200 text-gray-700'); ?>">
                            <?php echo e(str_replace('_', ' ', $admin->role)); ?>

                        </span>
                    </td>
                    <td class="px-6 py-5 flex gap-3">
                        <button onclick="openModal('edit', <?php echo e($admin->toJson()); ?>)" class="text-blue-500 hover:text-blue-700" title="Edit">
                            <i data-lucide="edit" class="w-5 h-5"></i>
                        </button>
                        <form action="<?php echo e(route('manage_admin.destroy', $admin->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this admin?')">
                            <?php echo csrf_field(); ?>
...
<div id="adminModal" class="fixed inset-0 bg-black/50 hidden z-50 flex items-center justify-center p-4 backdrop-blur-sm">
    <div class="bg-white rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl flex flex-col">
        ...
        <form id="adminForm" method="POST" action="<?php echo e(route('manage_admin.store')); ?>" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
function openModal(mode, data = null) {
    ...
    if (mode === 'edit' && data) {
        ...
        form.action = '<?php echo e(route("manage_admin.store")); ?>';
...
<?php echo $__env->make('partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Herd\webdev-frombroole\resources\views/manage_admin.blade.php ENDPATH**/ ?>