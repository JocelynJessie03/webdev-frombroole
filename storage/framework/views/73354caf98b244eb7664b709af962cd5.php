...
x-data="{
currentSlide:0,
desserts: <?php echo e(Js::from($signatureDesserts)); ?>
...
<section class="relative overflow-hidden bg-gradient-to-r from-[#F7ECEB] via-[#F5F2EE] to-[#EFECE7] text-[#3D3833] py-10 px-6 sm:px-10 lg:px-16 rounded-b-[48px] shadow-sm min-h-[980px] lg:min-h-[760px] flex items-center">
    ...
    <a href="<?php echo e(route('customer.about')); ?>"
...
<section class="max-w-[1800px] mx-auto px-10 mt-28">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-20">
        ...
        :class="{
        'bg-[#241915] border-[#5B4337] hover:shadow-[0_35px_90px_rgba(36,25,21,0.55)]': <?php echo e($index); ?> === 0,

        'bg-[#5A0C12] border-[#7A1A25] hover:shadow-[0_35px_90px_rgba(90,12,18,0.45)]': <?php echo e($index); ?> === 1,

        'bg-[#A8874F] border-[#C8AE79] hover:shadow-[0_35px_90px_rgba(168,135,79,0.45)]': <?php echo e($index); ?> === 2
        }"
        >
            ...
            <div class="relative h-[290px] mx-5 mt-5 rounded-[24px] overflow-visible border border-white/10 bg-black/10 backdrop-blur-sm flex items-center justify-center px-8 py-8 group-hover:z-50 transition-all duration-700">
                ...
                <img
                    ...
                    <?php echo e($index === 0 ? 'w-[260px] lg:w-[320px]' : ''); ?>

                    <?php echo e($index === 1 ? 'w-[250px] lg:w-[310px]' : ''); ?>

                    <?php echo e($index === 2 ? 'w-[240px] lg:w-[300px]' : ''); ?>
            ...
            <div class="px-7 pt-6 pb-7">
                ...
                <span class="text-[10px] uppercase tracking-[0.25em] font-black text-[#E6C07B]">
                    <?php echo e(strtoupper($item['tagline'])); ?>
                ...
                <p class="text-[14px] leading-[1.9] text-white/75 mt-5">
                   ...
                   <a
    href="<?php if($index === 0): ?>
            <?php echo e(route('customer.shop', ['category' => 3])); ?>

          <?php elseif($index === 1): ?>
            <?php echo e(route('customer.shop', ['category' => 1])); ?>

          <?php else: ?>
            <?php echo e(route('customer.shop', ['category' => 2])); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Herd\webdev-frombroole\resources\views/customer/home.blade.php ENDPATH**/ ?>