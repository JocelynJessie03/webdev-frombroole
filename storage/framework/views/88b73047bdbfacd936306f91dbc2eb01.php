        ...
        <div class="p-6 overflow-y-auto flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-[#faf7f5] p-5 rounded-2xl border">
                ...
                <form action="<?php echo e(route('admin.tasks.store')); ?>" method="POST" class="space-y-3" id="taskForm">
                    ...
                    <div id="minPurchasesContainer">
                        <label class="block text-[11px] font-bold text-gray-500 uppercase mb-1">Min Purchases (Total Orders)</label>
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">Syarat minimal jumlah transaksi yang harus dicapai customer.</p>
                    </div>
                    
                    <div id="minOrdersContainer" class="hidden">
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">Syarat tambahan minimal total transaksi (selain membeli produk di atas).</p>
                    </div>
...
function updateProductSelector() {
    ...
    const minPurchasesContainer = document.getElementById('minPurchasesContainer');
    const minOrdersContainer = document.getElementById('minOrdersContainer');
    
    if (taskType === 'product_specific') {
        productSelector.classList.remove('hidden');
        minPurchasesContainer.classList.add('hidden');
        minOrdersContainer.classList.remove('hidden');
    } else {
        productSelector.classList.add('hidden');
        minPurchasesContainer.classList.remove('hidden');
        minOrdersContainer.classList.add('hidden');
