            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div class="flex justify-between mb-3">
                        ...
                        <span class="text-base font-bold text-gray-700"><?php echo e($item['sold']); ?></span>
                    </div>
        ...
        <div class="bg-white rounded-[40px] p-10 shadow-sm">
            ...
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="border border-gray-100 rounded-2xl p-5">
                    <p class="text-sm text-gray-500 mb-2"><?php echo e($inv['name']); ?></p>
                    <p class="text-2xl font-black text-[#7b0000] mb-3"><?php echo e($inv['qty']); ?></p>
                    <span class="text-xs font-bold px-3 py-1 rounded-full <?php echo e($inv['badge_color']); ?>">
                        <?php echo e($inv['badge']); ?>
