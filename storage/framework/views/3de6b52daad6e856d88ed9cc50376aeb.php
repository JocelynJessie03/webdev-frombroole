...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-3xl border shadow-sm p-10">
        ...
        <form action="<?php echo e(route('ingredient.store')); ?>"
              method="POST"
              class="space-y-8">
...
<?php echo $__env->make('partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Herd\webdev-frombroole\resources\views/ingredient/create.blade.php ENDPATH**/ ?>