...
<div id="main-container">
    ...
    <div class="px-5 space-y-1.5 flex-1">
        ...
        <a href="<?php echo e(route('order_history')); ?>" 
           class="menu-item flex items-center gap-4 px-5 py-3 rounded-2xl text-lg transition-all 
        ...
        <a 
            href="<?php echo e($admin && $admin->isSuperAdmin() ? route('customers') : '#'); ?>"
            class="menu-item flex items-center gap-4 px-5 py-3 rounded-2xl text-lg transition-all
            <?php echo e($admin && $admin->isSuperAdmin()
        ...
        <a 
            href="<?php echo e($admin && $admin->isSuperAdmin() ? route('reports') : '#'); ?>"
            class="menu-item flex items-center gap-4 px-5 py-3 rounded-2xl text-lg transition-all
            <?php echo e($admin && $admin->isSuperAdmin()
...
</html><?php /**PATH C:\Users\Jessiee\Herd\frombroole\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>