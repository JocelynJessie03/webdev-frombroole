...
(function () {
    ...
    let toastTimer  = null;
    updateCartUI();
    window.addToCart = function (id, name, price, maxStock, isDrink) {
        if (maxStock <= 0) {
    ...
    window.viewCart = function () {
        window.location.href = '/cart'; /* adjust to your cart route */
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Herd\webdev-frombroole\resources\views/customer/shop.blade.php ENDPATH**/ ?>